...
from TwitterScrapperRoHec.tweet import Tweet
from TwitterScrapperRoHec.ts_logger import logger
...
def query_tweets(query, limit=None, begindate=dt.date(2018, 1, 1), enddate=dt.date.today(), poolsize=1, lang=''):
